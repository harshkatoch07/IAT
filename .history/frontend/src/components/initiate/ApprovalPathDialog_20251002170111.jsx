          ...
          <Stack spacing={2.25}>
            {steps.map((s, idx) => {
              ...
              const primary = isInitiator
                ? (s.approverName || trail?.initiatorName || "Initiator")
                : (s.approverName || s.designationName || "Approver");
              const sub = isInitiator
                ? (s.designationName ? `(${s.designationName})` : "—")
                : (s.designationName && s.approverName ? `(${s.designationName})` : "—");
